...
def hand_drawing_prediction(images):
    ...
    Model = load_model("D:\PycharmProjects\pythonProject1\gp_circle\models\CNN_fusion98.1oldCNN_arc.h5")
...
def audio_prediction(audio):
    ...
    loaded_pipeline = joblib.load("D:\PycharmProjects\pythonProject1\gp_circle\endmodels\8000\pipeline_with_normalization240.joblib")
